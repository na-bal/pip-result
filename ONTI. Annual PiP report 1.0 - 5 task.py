...
def comparising(val, answer):
    ...
    task_1_informatics_step_id = '1974489'

    task_2 = 2
    task_2_for_row_val = 3
    task_2_informatics_step_id = '1974493'

    task_3 = 3
    task_3_for_row_val = 4
    task_3_informatics_step_id = '1974491'

    task_4 = 4
    task_4_for_row_val = 5
    task_4_informatics_step_id = '1974492'

    task_5 = 5
    task_5_for_row_val = 6
    task_5_informatics_step_id = '1974494'
...
def reply_outputs(comparising_result):
    ...
    myFile = open('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Выгрузки/Автоматизация бизнес-процессов. Итоговая сборка.csv', 'w')
    with myFile:
        writer = csv.writer(myFile)
        writer.writerows(data)
    # return data

...
def bug_report(val, reply_outputs, bug_output):
    ...
    if cnt_val != cnt_reply:
        ...
        for row_val in val:
            if row_val[0] not in stepic_lst and (row_val[2] != '0' or row_val[3] != '0' or row_val[4] != '0' or row_val[5] != '0' or row_val[6] != '0'):
                print(row_val)
                data += ([
                    [cnt_val] +
                    [cnt_reply] +
...
# informatics_step_id = ['2037756', '2037757', '2037758', '2037759', '2037755']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Анализ космических снимков и геопространственных данных. Итоговый протокол (финальные баллы участников) - Протокол по предмету 1 (для скрипта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Анализ космических снимков и геопространственных данных. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Анализ космических снимков и геопространственных данных. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Анализ космических снимков и геопространственных данных. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)


# Аэрокосмические системы
# informatics_step_id = ['2037756', '2037757', '2037758', '2037759', '2037755']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Аэрокосмические системы. Итоговый протокол (финальные баллы участников) - Протокол по предмету 2 (для скприпта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Аэрокосмические системы. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Аэрокосмические системы. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Аэрокосмические системы. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)

# Спутниковые системы
# informatics_step_id = ['2037756', '2037757', '2037758', '2037759', '2037755']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Спутниковые системы. Итоговый протокол (финальные баллы участников) - Протокол по предмету 2 (для скрипта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Спутниковые системы. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Спутниковые системы. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Спутниковые системы. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)

# Интеллектуальные энергетические системы
# informatics_step_id = ['2037756', '2037757', '2037758', '2037759', '2037755']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Интеллектуальные энергетические системы. Итоговый протокол (финальные баллы участников) - Протокол по предмету 1 (для скрипта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Интеллектуальные энергетические системы. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Интеллектуальные энергетические системы. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Интеллектуальные энергетические системы. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)

# Информационная безопасность
informatics_step_id = ['1985304', '1985307', '1985305', '1985308', '1985306']
val = read_csv_informatics('/Users/nabal/Downloads/Информационная безопасность. Итоговый протокол (финальные баллы участников) - Протокол по предмету 2 (для скрипта) (копия).csv')
answer = read_csv_informatics_output('/Users/nabal/Downloads/Информационная безопасность. Решения - Лист1.csv')
result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Информационная безопасность. Итоговая сборка.csv'
bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Информационная безопасность. Bugs.csv'
comparising_result = comparising(val, answer, informatics_step_id)


# Технологии беспроводной связи
# informatics_step_id = ['1934940', '1935461', '1936348', '1937030', '1944583']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии беспроводной связи. Итоговый протокол ТБС 14.03.21-20.03.21.xlsx - Протокол по предмету 2 (для скрипта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии беспроводной связи. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии беспроводной связи. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии беспроводной связи. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)

# Технологии дополненной реальности
# informatics_step_id = ['2045739', '2045742', '2045741', '2045740', '2045743']
# val = read_csv_informatics('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии дополненной реальности. Итоговый протокол (финальные баллы участников) - Протокол по предмету 1 (для скрипта) -- 5 задач.csv')
# answer = read_csv_informatics_output('/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии дополненной реальности. Решения.csv')
# result_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии дополненной реальности. Итоговая сборка.csv'
# bug_output = '/Users/nabal/Downloads/!!! СБОРКААААА - предметка/!!!!!! Информатика/Итоговая сборка информатики — копия/Технологии дополненной реальности. Bugs.csv'
# comparising_result = comparising(val, answer, informatics_step_id)
